...
app = Flask(__name__)
app.secret_key = os.getenv('SECRET_KEY', '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')
app.config['UPLOAD_FOLDER'] = 'static/uploads'
app.config['MAX_CONTENT_LENGTH'] = 8 * 1024 * 1024  # Ukuran file maks 8 MB

# Konfigurasi OpenAI API
client = OpenAI(api_key=os.getenv('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'))
